...
Research in organizational behavior consistently shows that perceived unfairness in credit attribution reduces motivation and team cohesion [@lerner-tetlock-1999]. Tools that make contribution visible serve not only evaluative purposes but also act as accountability mechanisms that encourage equitable participation. CoTrace is designed with this dual function in mind: it is both an analytics instrument and a transparency mechanism that benefits all stakeholders in a collaborative project.
